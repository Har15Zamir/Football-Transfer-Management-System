...
--  Sample data uses hardcoded PKs for FK safety — see Section 9.
-- ────────────────────────────────────────────────────────────
CREATE SEQUENCE seq_person      START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE seq_agent       START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE seq_club        START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE SEQUENCE seq_competition START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
--  ON DELETE CASCADE: deleting a Person cascades to Contract,
--  which further cascades to EmploymentContract / SponsorshipContract.
-- ────────────────────────────────────────────────────────────
...
-- Managers (personId 6–8): subclass rows inserted in Section 9.4
INSERT INTO Person (personId,firstName,lastName,dateOfBirth,nationality,email,phoneNumber)
